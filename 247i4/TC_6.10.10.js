//6.10.10 -- Use of Extended OMCI in a Software Download using the OMCI Maximum Message Size
testPassed("Use of Extended OMCI in a Software Download using the OMCI Maximum Message Size");
...
var OMCC = ONUID;
var windowSize = 32;
var OMCIPayloadSize = 1964; ///max size is 1965, but includes the section number (1 byte)
...
if (lastWindowSize) {
    /// Send last window
    logInfo("Sending last window:" + lastWindowSize + " sections");
