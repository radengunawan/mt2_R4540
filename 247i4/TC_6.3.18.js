// Maximum Number of Dynamic Multicast Groups Modification
testPassed("Maximum Number of Dynamic Multicast Groups Modification");
...
///Step 8. Cause the OLT Emulator to specify to value 2 the maximum number of dynamic multicast groups that may be replicated at the ONU

testPassed("Step 8. Cause the OLT Emulator to specify to value 2 the maximum number of dynamic multicast groups that may be replicated at the ONU");
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var struct = TrafficGenerator.SendTemplateConfig("6.3.18", [
        ["<SPbit1>", SPbit1 << 1, 1],
        ["<SVID1>", SVID1, 3],
...
///Step 11. Cause the OLT emulator to specify to value 1 the maximum number of dynamic multicast groups that may be replicated at the ONU

testPassed("Step 11. Cause the OLT emulator to specify to value 1 the maximum number of dynamic multicast groups that may be replicated at the ONU");

OMCI.Set(OMCC, "Multicast_Subsc_Config_Info", BPCD3, { MaxSimulGroups: 1 });
...
OMCI.Set(OMCC, "Multicast_Subsc_Config_Info", BPCD3, { MaxSimulGroups: 2 });
