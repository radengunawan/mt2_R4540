//Test Case on downstream translation for code point 0
include("Config.js");
...
addTranslationEthToGpon(SVIDs[0], SPbits[0], GEM1);
addTranslationEthToGpon(SVIDs[0], SPbits[1], GEM2);
addTranslationEthToGpon(SVIDs[1], SPbits[2], GEM3);
addTranslationEthToGpon(SVIDs[2], SPbits[3], GEM4);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.30", [
        ["<SVID1>", SVIDs[0], 3],
        ["<SVID2>", SVIDs[1], 3],
        ["<SVID3>", SVIDs[2], 3],
        ["<CVID1>", CVIDs[0], 3],
