...
//Test case 6.1.12 Deriving p-bits as a function of received user port
...
TrafficGenerator.GEMTranslationMode = LoadValue('GEMTranslationMode', 'legacy');///acceptable values: 'ignore', 'legacy'
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.12", [
                ["<SVID1>", SVID1, 3],
                ["<CVID1>", CVID1, 3],
                ["<SPbits1>", SPbits1 << 1, 1],
                ["<SPbits2>", SPbits2 << 1, 1],
