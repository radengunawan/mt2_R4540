...
//Test case 6.1.26 Deriving p-bits as a function of received Ethertype (single user port)
/// Initialize Variables
var SVID1 = RandomInteger(1, 4094); /// SVID1 randomly chosen in range [1..4094]
var CVID1 = RandomIntegerExcept(1, 4094, [SVID1]);
var ONUID = 1;
var OMCC = ONUID;
...
//Add SVID1 to all 0x8863 Ethertype frames. Use pbit value of Pbit1
...
//Add SVID1 to all 0x0800 Ethertype frames. Use pbit value of Pbit2
OMCI.Set(OMCC, "Ext_VLAN_Tagging_Opr_Config_Data", EVTOCD1, {
    "RcvFrameVLANTagOperTbl": {
        "FilterOuterPriority": 15,
        "FilterOuterVID": 4096,
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.26", [
                ["<SVID1>", SVID1, 3],
                ["<CVID1>", CVID1, 3],
                ["<SPbits1>", SPbits1 << 1, 1],
                ["<SPbits2>", SPbits2 << 1, 1],
