...
//Test case 6.2.8 Mapping traffic into GEM Ports based on VID values in the upstream direction (multiple user port)
...
var IWTP4 = OMCI.Create(OMCC, "GEM_Interworking_Termination_Point", { GEMPortNetworkCTPPointer: CTP4, ServiceProfilePointer: PMAP4, GALProfilePointer: GAL });
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.2.8", [
        ["<CVID1>", CVID1, 3],
        ["<CVID2>", CVID2, 3],
        ["<CPbits1>", CPbits1 << 1, 1],
        ["<CPbits2>", CPbits2 << 1, 1],
        ...
        "Frame Set F": [0xffff, 0xff, 0xffff, GEM3],
        "Frame Set G": [0xffff, 0xff, 0xffff, GEM4],
