...
var CVID2 = RandomInteger(1, 4094); /// CVID2 randomly chosen in range [1..4094]
var SVID1 = RandomIntegerExcept(1, 4094, [CVID2]); /// SVID1 randomly chosen in range [1..4094]
var SVID2 = RandomIntegerExcept(1, 4094, [CVID2, SVID1]); /// SVID2 randomly chosen in range [1..4094]
var SVID3 = RandomIntegerExcept(1, 4094, [CVID2, SVID1, SVID2]); /// SVID3 randomly chosen in range [1..4094]
var SVID10 = RandomIntegerExcept(1, 4094, [CVID2, SVID1, SVID2, SVID3]); /// SVID10 randomly chosen in range [1..4094]
var SVID20 = RandomIntegerExcept(1, 4094, [CVID2, SVID1, SVID2, SVID3, SVID10]); /// SVID20 randomly chosen in range [1..4094]
var ONUID = 1;
var OMCC = ONUID;
...
logInfo("Random values: SPbits1 = " + SPbits1 + " ; SPbits2 = " + SPbits2 + " ; SPbits3 = " + SPbits3);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.6", [
        ["<SVID1>", SVID1, 3],
        ["<SVID2>", SVID2, 3],
        ["<SVID3>", SVID3, 3],
        ["<SVID10>", SVID10, 3],
