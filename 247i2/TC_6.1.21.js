...
var QVID1 = RandomInteger(1, 4094); /// QVID1 randomly chosen in range [1..4094]
var CVID2 = RandomIntegerExcept(1, 4094, [QVID1]); /// CVID2 randomly chosen in range [1..4094]
var SVID2 = RandomIntegerExcept(1, 4094, [QVID1, CVID2]); /// SVID2 randomly chosen in range [1..4094]
var ONUID = 1;
var OMCC = ONUID;
...
var TF = OMCI.Create(OMCC, "VLAN_Tagging_Filter_Data", { meid: BPCD1, VLANFilterList: [CVID2], ForwardOpr: 16, NumberOfEntries: 1 });
...
logInfo("Random values: QVID1=" + QVID1 + "; CVID2=" + CVID2);
logInfo("Random value: SVID2=" + GEM1);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    /// Replace QVID1 by the value formatted on 3 hex digit
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.21", [
        ["<QVID1>", QVID1, 3],
        ["<CVID2>", CVID2, 3],
        ["<SVID2>", SVID2, 3],
        ["<CPbits1>", CPbits1 << 1, 1],
