...
//Test case 6.1.18 - VID Support for Priority Tagged Frames without Priority Preservation (1:1 VLAN Architecture Double-Tagged at the V Interface)
...
var AllocId1 = GEM1;
var CPbits2 = RandomInteger(0, 7);
var CPbits1 = RandomIntegerExcept(0, 7, [CPbits2]);
var CPbits3 = RandomIntegerExcept(0, 7, [CPbits2, CPbits1]);
var CPbits4 = RandomIntegerExcept(0, 7, [CPbits2, CPbits1, CPbits3]);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.18", [
        ["<CVID1>", CVID1, 3],
        ["<CVID2>", CVID2, 3],
        ["<CPbits1>", CPbits1 << 1, 1],
        ["<CPbits2>", CPbits2 << 1, 1],
