...
//Test case 6.1.15 - VID Support for Priority Tagged Frames with Priority Preservation (N:1 VLAN or 1:1 VLAN Architecture Single-Tagged at the V Interface)
...
// Filtering on Priority Tagged Frames, preserve Pbits
...
logInfo("Random value: SPbits1=CPbits1=" + CPbits1);
logInfo("Random value: SPbits2=CPbits2=" + CPbits2);
logInfo("Random value: SPbits4=CPbits4=" + CPbits4);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.15", [
        ["<SVID1>", SVID1, 3],
        ["<SVID2>", SVID2, 3],
        ["<CPbits1>", CPbits1 << 1, 1],
        ["<CPbits2>", CPbits2 << 1, 1],
