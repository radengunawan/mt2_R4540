...
//Test case 6.1.16 - VID Support for Priority Tagged Frames without Priority Preservation (N:1 VLAN or 1:1 VLAN Architecture Single-Tagged at the V Interface)
...
var CPbits1 = RandomIntegerExcept(0, 7, [SPbits1]);
var CPbits2 = RandomIntegerExcept(0, 7, [SPbits1, CPbits1]);
var CPbits3 = RandomIntegerExcept(0, 7, [SPbits1, CPbits1, CPbits2]);
var CPbits4 = RandomIntegerExcept(0, 7, [SPbits1, CPbits1, CPbits2, CPbits3]);
...
logInfo("Random value: CPbits3=" + CPbits3);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.16", [
        ["<SVID1>", SVID1, 3],
        ["<SVID2>", SVID2, 3],
        ["<SPbits1>", SPbits1 << 1, 1],
        ["<CPbits1>", CPbits1 << 1, 1],
