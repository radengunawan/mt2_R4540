...
// !! Modification from OISG sequence
// TreatInnerTPIDy 0 -> 6
...
/// All frame received from the GEM1/2/3 has to be replicated on OLT Ethernet port
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var GEMTable = {
        "Frame Set A": [{port: GEM1, translationRule: {nbTagToCheck: 2, outerTpid: 0x88a8, outerVid: SVID1, outerPbit: SPbits1, innerTpid: 0x8100, innerVid: CVID1}}],
        "Frame Set B": [{port: GEM2, translationRule: {nbTagToCheck: 2, outerTpid: 0x88a8, outerVid: SVID1, outerPbit: SPbits2, innerTpid: 0x8100, innerVid: 0}}],
        "Frame Set C": [{port: GEM3, translationRule: {nbTagToCheck: 1, innerTpid: 0x88a8, innerVid: SVID1, innerPbit: SPbits3}}],
    };
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.4", [
                ["<SVID1>", SVID1, 3],
                ["<CVID1>", CVID1, 3],
                ["<SPbits1>", SPbits1 << 1, 1],
                ["<SPbits2>", SPbits2 << 1, 1],
    ...
    var verdict = TrafficGenerator.ApplyVerdict(result, {
        "Frame Set A": { "Frame Set A": TrafficGenerator.nbOfPacketToSend, "Frame Set B": 0, "Frame Set C": 0, "TID 1:0": TrafficGenerator.nbOfPacketToSend },
        "Frame Set B": { "Frame Set A": 0, "Frame Set B": TrafficGenerator.nbOfPacketToSend, "Frame Set C": 0, "TID 2:0": TrafficGenerator.nbOfPacketToSend },
        "Frame Set C": { "Frame Set A": 0, "Frame Set B": 0, "Frame Set C": TrafficGenerator.nbOfPacketToSend, "TID 3:0": TrafficGenerator.nbOfPacketToSend }
    });
