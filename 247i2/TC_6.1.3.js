...
var SPbits2 = RandomIntegerExcept(0, 7, [SPbits1, CPbits1]);
var CPbits3 = RandomIntegerExcept(0, 7, [SPbits1, CPbits1, SPbits2]);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.3", [
                ["<SVID1>", SVID1, 3],
                ["<CVID1>", CVID1, 3],
                ["<CPbits1>", CPbits1 << 1, 1],
                ["<CPbits3>", CPbits3 << 1, 1],
