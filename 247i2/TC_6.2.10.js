...
//Test case 6.2.10 Mapping multiple p-bit values to the same GEM port (single user port)
...
var CPbits3 = RandomIntegerExcept(0, 7, [CPbits1, CPbits2]);
var CPbits4 = RandomIntegerExcept(0, 7, [CPbits1, CPbits2, CPbits3]);
...
logInfo("Random values: CPbits1=" + CPbits1 + " ; CPbits2=" + CPbits2 + " ; CPbits3=" + CPbits3 + " ; CPbits4=" + CPbits4);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.2.10", [
        ["<CVID1>", CVID1, 3],
        ["<CPbits1>", CPbits1 << 1, 1],
        ["<CPbits2>", CPbits2 << 1, 1],
        ["<CPbits3>", CPbits3 << 1, 1],
        ...
        "Frame Set B": [0xffff, 0xff, 0xffff, GEM1],
        "Frame Set C": [0xffff, 0xff, 0xffff, GEM2],
        "Frame Set D": [0xffff, 0xff, 0xffff, GEM2],
        "Frame Set Z-GEM1": [0xffff, 0xff, 0xffff, GEM1],
        "Frame Set Z-GEM2": [0xffff, 0xff, 0xffff, GEM2]
    });
    ...
    var verdict = TrafficGenerator.ApplyVerdict(result, {
        ...
        "Frame Set Z-GEM1": { "TID 5:0": 0 },
        "Frame Set Z-GEM2": { "TID 6:0": 0 }
    });
