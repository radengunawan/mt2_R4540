...
var QVID1 = RandomInteger(1, 4094); /// CVID1 randomly chosen in range [1..4094]
var SVID2 = RandomIntegerExcept(1, 4094, [QVID1]); /// SVID2 randomly chosen in range [1..4094]
var QVID2 = RandomIntegerExcept(1, 4094, [QVID1, SVID2]); /// CVID2 randomly chosen in range [1..4094]
var ONUID = 1;
var OMCC = ONUID;
...
logInfo("Random values: QVID1=" + QVID1 + "; SVID2=" + SVID2);
logInfo("Random value: QVID2=" + QVID2);
...
if (TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("6.1.22", [
        ["<QVID1>", QVID1, 3],
        ["<QVID2>", QVID2, 3],
        ["<SVID2>", SVID2, 3],
        ["<CPbits1>", CPbits1 << 1, 1],
