...
/// Only simple tag frame received from the GEM1 has to be detag and replicated on OLT Ethernet port
addTranslationGponToEthExt2({
    nbTagToCheck: 1,
    innerVid: 0xffff,
    innerPbit: 0xff,
    innerTpid: 0xffff,
...
if (testTraffic && TrafficGenerator.activateAutomatisation) {
    ...
    var result = TrafficGenerator.SendTemplateConfigAndDoTest("PassThru", [
        ["<MAC1>", MAC1, 0xC],
        ["<MAC2>", MAC2, 0xC],
    ]);
